        ...
        {{--<div class="row mt-n2-6">--}}
            {{--<div class="col-sm-6 col-lg-3 mt-2-6">--}}
                {{--<div class="footer-logo mb-1-9">--}}
                    {{--<a href="index.html"><img src="./website-assets/img/logos/footer-light-logo.png" alt="..."></a>--}}
                {{--</div>--}}
                {{--<p class="text-white mb-1-6 mb-lg-1-9 opacity9">Welcome to my world of Nutrition! I'm DHRUVI, a passionate and QUALIFIED CLINICAL DIETITIAN and NUTRITION COUNSELLOR.</p>--}}
                ...
                {{--<div class="ps-xl-1-9">--}}
                    ...
                    {{--<div class="d-flex align-items-center mb-1-9">--}}
                        {{--<div class="flex-shrink-0">--}}
                            {{--<img src="./website-assets/img/content/footer-thumb1.jpg" class="w-70px border-radius-10" alt="...">--}}
                        {{--</div>--}}
                        {{--<div class="flex-grow-1 ps-3">--}}
                            {{--<h4 class="h6"><a href="#!" class="text-white opacity9">What I wish everyone knew about exercise.</a></h4>--}}
                            {{--<small class="text-secondary">15 mar. 2022</small>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                    {{--<div class="d-flex align-items-center">--}}
                        {{--<div class="flex-shrink-0">--}}
                            {{--<img src="./website-assets/img/content/footer-thumb2.jpg" class="w-70px border-radius-10" alt="...">--}}
                        {{--</div>--}}
                        {{--<div class="flex-grow-1 ps-3">--}}
                            {{--<h4 class="h6"><a href="#!" class="text-white opacity9">Seven various ways to do healthy food.</a></h4>--}}
                            {{--<small class="text-secondary">12 mar. 2022</small>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                {{--</div>--}}
            {{--</div>--}}
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-start mt-3 mt-md-0 order-2 order-md-1">
                    <p class="d-inline-block text-white mb-0 display-30 display-lg-29">&copy; <span class="current-year"></span> Powered By <a href="#!" class="text-secondary white-hover">Dhruvi Chokshi</a></p>
                </div>
